    ...
    public void OpenColor(){
        AmbilWarnaDialog color = new AmbilWarnaDialog(this, mDefaulColor, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            ...
            public void onOk(AmbilWarnaDialog dialog, int color) {
                ...
                Toast.makeText(DrawingActivity.this, R.string.FORMAT_1 +String.format("#%X", mDefaulColor )+ R.string.FORMAT_2 +"#"+Integer.toHexString(mDefaulColor) , Toast.LENGTH_LONG).show();
            }
        });
        color.show();
    }
