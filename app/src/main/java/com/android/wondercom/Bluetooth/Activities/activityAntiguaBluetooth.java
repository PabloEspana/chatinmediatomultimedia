...
import com.android.wondercom.Bluetooth.Controllers.ChatController;
...
public class activityAntiguaBluetooth extends AppCompatActivity {
    ...
    private ChatController chatController;  // clase chat controller
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antigua_bluetooth);
            ...
            switch (msg.what) {
                ...
                case MESSAGE_READ:      // Si es mensaje lectura
                    ...
                    try{
                        ...
                        Toast.makeText(activityAntiguaBluetooth.this, e.toString(), Toast.LENGTH_SHORT).show();
                    }
                    break;
            ...
            public void onClick(View view) {
                if (tipo_mensaje.equals("texto")){
                    if (inputLayout.getEditText().getText().toString().equals("")) {
                        Toast.makeText(activityAntiguaBluetooth.this, "Escriba un mensaje por favor", Toast.LENGTH_SHORT).show();
                    } else {
